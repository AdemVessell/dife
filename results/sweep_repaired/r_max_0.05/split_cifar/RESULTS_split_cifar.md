...
|--------|------|------|-------|-----|--------------|-------------|
| DIFE_only          | 0.763±0.013 | 0.185±0.018 | -0.185±0.018 | 0.118±0.005 | 5,688±0 | 0.0000 |
| DIFE_MV            | 0.762±0.010 | 0.193±0.010 | -0.193±0.010 | 0.116±0.010 | 5,688±0 | 0.0000 |
...
Method: DIFE_only
  ...
  t=3    0.8911       0.0106      0.001000   0.000000
  t=4    0.8574       0.0069      0.012772   0.018761
  t=5    0.8933       0.0046      0.001000   0.000000

Method: DIFE_MV
  t=1    0.9000       0.0000      0.010000   0.000000
  t=2    0.9000       0.0000      0.010000   0.000000
  t=3    0.8950       0.0102      0.001000   0.000000
  t=4    0.8610       0.0080      0.004804   0.007608
  t=5    0.8952       0.0029      0.001000   0.000000
...
Method: DIFE_MV
  seed=0: 12 epochs recorded, non-zero values: 12, max=0.4150, mean=0.2921
  seed=1: 12 epochs recorded, non-zero values: 12, max=0.4850, mean=0.2825
  seed=2: 12 epochs recorded, non-zero values: 12, max=0.4550, mean=0.2708
  seed=3: 12 epochs recorded, non-zero values: 12, max=0.4100, mean=0.2650
  seed=4: 12 epochs recorded, non-zero values: 12, max=0.4300, mean=0.2479
