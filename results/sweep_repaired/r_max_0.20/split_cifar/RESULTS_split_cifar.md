...
|--------|------|------|-------|-----|--------------|-------------|
| DIFE_only          | 0.822±0.003 | 0.111±0.002 | -0.111±0.002 | 0.137±0.009 | 23,700±0 | 0.0000 |
| DIFE_MV            | 0.819±0.009 | 0.120±0.009 | -0.120±0.009 | 0.139±0.008 | 23,589±221 | 0.0000 |
...
Method: DIFE_only
  ...
  t=3    0.9452       0.0061      0.001000   0.000000
  t=4    0.9266       0.0093      0.001000   0.000000
  t=5    0.9440       0.0048      0.001000   0.000000

Method: DIFE_MV
  t=1    0.9000       0.0000      0.010000   0.000000
  t=2    0.9000       0.0000      0.010000   0.000000
  t=3    0.9524       0.0046      0.001000   0.000000
  t=4    0.9353       0.0058      0.001000   0.000000
  t=5    0.9469       0.0033      0.001000   0.000000
...
Method: DIFE_MV
  seed=0: 12 epochs recorded, non-zero values: 12, max=0.3100, mean=0.1963
  seed=1: 12 epochs recorded, non-zero values: 12, max=0.3100, mean=0.1883
  seed=2: 12 epochs recorded, non-zero values: 12, max=0.3650, mean=0.1883
  seed=3: 12 epochs recorded, non-zero values: 12, max=0.3000, mean=0.1867
  seed=4: 12 epochs recorded, non-zero values: 12, max=0.3250, mean=0.1792
