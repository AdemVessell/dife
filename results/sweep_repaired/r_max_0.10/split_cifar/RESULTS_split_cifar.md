...
|--------|------|------|-------|-----|--------------|-------------|
| DIFE_only          | 0.787±0.007 | 0.160±0.006 | -0.160±0.006 | 0.124±0.003 | 11,376±0 | 0.0000 |
| DIFE_MV            | 0.792±0.006 | 0.153±0.009 | -0.153±0.009 | 0.128±0.007 | 11,376±0 | 0.0000 |
...
Method: DIFE_only
  ...
  t=3    0.9284       0.0119      0.001000   0.000000
  t=4    0.8931       0.0117      0.001000   0.000000
  t=5    0.9183       0.0043      0.001000   0.000000

Method: DIFE_MV
  t=1    0.9000       0.0000      0.010000   0.000000
  t=2    0.9000       0.0000      0.010000   0.000000
  t=3    0.9255       0.0156      0.001000   0.000000
  t=4    0.8962       0.0059      0.001000   0.000000
  t=5    0.9212       0.0042      0.001000   0.000000
...
Method: DIFE_MV
  seed=0: 12 epochs recorded, non-zero values: 12, max=0.4350, mean=0.2421
  seed=1: 12 epochs recorded, non-zero values: 12, max=0.3700, mean=0.2412
  seed=2: 12 epochs recorded, non-zero values: 12, max=0.4100, mean=0.2317
  seed=3: 12 epochs recorded, non-zero values: 12, max=0.3700, mean=0.2287
  seed=4: 12 epochs recorded, non-zero values: 12, max=0.3650, mean=0.2200
