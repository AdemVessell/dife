...
This project was developed using AI tools as co-developers — primarily Claude (Anthropic), Grok (xAI), ChatGPT (OpenAI), and Gemini (Google).
...
Claude, Grok, ChatGPT, and Gemini generated code to my specifications, helped scaffold test harnesses, assisted with boilerplate (CI config, packaging), and served as rapid iteration partners during development. Some branch names (e.g. `claude/...`) reflect Claude Code sessions where code was generated, reviewed, and committed in a single workflow.
